...
import com.litecdows.androidbluetoothserial.BluetoothManager;
...
public class MainActivityViewModel extends AndroidViewModel {
    ...
    public void refreshPairedDevices() {
        Collection<BluetoothDevice> bluetoothDevices_post = new ArrayList<>(bluetoothManager.getPairedDevices());
        bluetoothDevices_post.removeIf(bluetoothDevice -> !bluetoothDevice.getName().startsWith("YT"));
        pairedDeviceList.postValue(bluetoothDevices_post);
    }
